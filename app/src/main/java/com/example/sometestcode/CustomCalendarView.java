...
//    private Button addEventButton;
    private static final int MAX_CALENDAR_COLUMN = 35; //42
...
//    private DatabaseQuery mQuery;
    ...
    private void initializeUILayout(){
        ...
        View view = inflater.inflate(R.layout.custom_layout, this);
...
//        addEventButton = (Button)view.findViewById(R.id.add_calendar_event);
    ...
    public void setGridCellClickEvents(){
        final int previousSelectedPosition = -1;
        calendarGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                tv.setBackgroundResource(R.drawable.ic_favorite_heart_button);
            }
        });
    }
